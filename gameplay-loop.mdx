...
description: 'The gameplay is simple and loops like this: Acquire players → Build lineups → Compete → Earn rewards → Progress and repeat. Here's how it works step by step.'
---
